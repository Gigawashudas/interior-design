      ...
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col px-5 py-6 sm:px-6">
        ...
        <div className="my-auto py-12">
          ...
          <div className="border-t-4 border-[#F97316] pt-7">
            {" "}
            <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#F97316]"> Admin </p> <h1 className="mt-3 font-display text-4xl font-medium tracking-[-0.04em] sm:text-5xl"> Welcome back. </h1> <p className="mt-4 text-sm leading-6 text-black/50 dark:text-white/50"> Enter your password to access project inquiries. </p>{" "}
          </div>{" "}
